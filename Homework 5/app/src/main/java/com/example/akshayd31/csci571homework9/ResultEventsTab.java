 ...
 */
public class ResultEventsTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(resultData!=null && resultImages!=null){
            mAdapter = new ResultAdapter("event", resultData, resultImages, resultImageUrls, getContext());
    ...
    public class GetJsonDataFromServer extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String response = NetworkUtils.getNormalJsonDataFromServer(params[0], "event", false, null, getContext());
            try {
                resultData = new JSONObject(response);
    ...
    public void onResume() {
        ...
        if(sharedPreferences.getBoolean("event", false)){
            ...
            sharedPreferencesEditor.putBoolean("event", false);
