 ...
 */
public class ResultGroupsTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(resultData!=null && resultImages!=null){
            mAdapter = new ResultAdapter("group", resultData, resultImages, resultImageUrls, getContext());
    ...
    public class GetJsonDataFromServer extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String response = NetworkUtils.getNormalJsonDataFromServer(params[0], "group", false, null, getContext());
            try {
                resultData = new JSONObject(response);
    ...
    public void onResume() {
        ...
        if(sharedPreferences.getBoolean("group", false)){
            ...
            sharedPreferencesEditor.putBoolean("group", false);
