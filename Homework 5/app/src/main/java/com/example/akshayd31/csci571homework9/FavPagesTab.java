...
public class FavPagesTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(resultData!=null && resultImages!=null && resultImageUrls!=null){
            mAdapter = new FavoriteAdapter("page", resultData, resultImages, resultImageUrls, getContext());
    ...
    public class GetFavoriteDataFromServer extends AsyncTask<Void, Integer, String> {
        ...
        protected String doInBackground(Void... params) {
            resultData = NetworkUtils.getFavoriteDataFromSharedPreferences("page", getContext());
